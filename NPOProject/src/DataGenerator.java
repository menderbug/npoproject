...
public class DataGenerator {
	...
	public void drop() {
		List<String> tables = Arrays.asList("CurrentDate", "Department", "Donation", "Employee", "Expense", "Pledge", "Volunteer", "Donor", "Nonprofit");
	...
	private Date randDate() {
		long l = new GregorianCalendar(2021, 5, 3).getTimeInMillis() - new GregorianCalendar(2010, 1, 1).getTimeInMillis();
		return new Date(new GregorianCalendar(2010, 1, 1).getTimeInMillis() + (long) (Math.random() * l));
	}
